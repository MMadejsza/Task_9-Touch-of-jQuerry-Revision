...
function addComments() {
    showComments = comments.filter((item, index) => index < showComments.length + 250)
...
$(window).scroll(function () {
    const endScroll = $(document).height() - $(window).height() - $(window).scrollTop();
    // console.log(endScroll);

    if (Math.floor(endScroll) === 0) {
